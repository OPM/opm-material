...
private:
    ...
    std::vector<TabulatedOneDFunction> saturatedOilVaporizationFactorTable_;//could be taken form inverseGasB
    std::vector<TabulatedOneDFunction> saturationPressure_;//could be taken form inverseGasB
    // not need
