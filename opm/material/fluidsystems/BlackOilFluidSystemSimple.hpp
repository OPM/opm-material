...
/*!
 * \file
 * \copydoc Opm::BlackOilFluidSystemSimple
 */
#ifndef OPM_BLACK_OIL_FLUID_SYSTEM_SIMPLE_HPP
#define OPM_BLACK_OIL_FLUID_SYSTEM_SIMPLE_HPP
...
class BlackOilFluidSystemSimple //: public BaseFluidSystem<Scalar, BlackOilFluidSystemSimple<Scalar> >
{
    typedef BlackOilFluidSystemSimple ThisType;
...
template <class Scalar>
const int BlackOilFluidSystemSimple<Scalar>::phaseToSolventCompIdx_[3] =
{
...
template <class Scalar>
const int BlackOilFluidSystemSimple<Scalar>::phaseToSoluteCompIdx_[3] =
{
    -1, // water phase
...
template <class Scalar>
unsigned char BlackOilFluidSystemSimple<Scalar>::numActivePhases_;

template <class Scalar>
bool BlackOilFluidSystemSimple<Scalar>::phaseIsActive_[numPhases];

template <class Scalar>
short BlackOilFluidSystemSimple<Scalar>::activeToCanonicalPhaseIdx_[numPhases];

template <class Scalar>
short BlackOilFluidSystemSimple<Scalar>::canonicalToActivePhaseIdx_[numPhases];

template <class Scalar>
Scalar
BlackOilFluidSystemSimple<Scalar>::surfaceTemperature; // [K]

template <class Scalar>
Scalar
BlackOilFluidSystemSimple<Scalar>::surfacePressure; // [Pa]

template <class Scalar>
Scalar
BlackOilFluidSystemSimple<Scalar>::reservoirTemperature_;

template <class Scalar>
bool BlackOilFluidSystemSimple<Scalar>::enableDissolvedGas_;

template <class Scalar>
bool BlackOilFluidSystemSimple<Scalar>::enableVaporizedOil_;

template <class Scalar>
std::shared_ptr<OilPvtMultiplexer<Scalar> >
BlackOilFluidSystemSimple<Scalar>::oilPvt_;

template <class Scalar>
std::shared_ptr<Opm::GasPvtMultiplexer<Scalar> >
BlackOilFluidSystemSimple<Scalar>::gasPvt_;

template <class Scalar>
std::shared_ptr<WaterPvtMultiplexer<Scalar> >
BlackOilFluidSystemSimple<Scalar>::waterPvt_;

template <class Scalar>
std::vector<std::array<Scalar, 3> >
BlackOilFluidSystemSimple<Scalar>::referenceDensity_;

template <class Scalar>
std::vector<std::array<Scalar, 3> >
BlackOilFluidSystemSimple<Scalar>::molarMass_;

template <class Scalar>
bool BlackOilFluidSystemSimple<Scalar>::isInitialized_ = false;
